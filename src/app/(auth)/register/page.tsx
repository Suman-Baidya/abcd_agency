  ...
  return (
    <div className="w-full max-w-2xl mx-auto py-2">
      ...
      <div className="text-center mb-5">
        ...
        <p className="mt-1.5 text-xs sm:text-sm text-[#737373] dark:text-neutral-400">
          Join ABCD Agency to access your client portal and projects.
        </p>
      </div>
      ...
      <Card variant="default" className="p-6 sm:p-8">
        ...
        <div className="space-y-4 mb-6">
          <a
            href="/api/auth/google?callbackUrl=/portal"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <span className="text-[10px] text-[#737373] mt-1 block">Minimum 8 characters</span>
              </div>
            ...
            <PasswordStrengthMeter password={formData.password} className="mt-4" />
          </div>
