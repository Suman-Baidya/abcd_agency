  ...
  return (
    <div className="space-y-8 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          <div className="h-8 w-56 bg-[#E5E5E5] dark:bg-[#262626] rounded-md" />
          <div className="h-4 w-64 bg-[#F0F0F0] dark:bg-[#1A1A1A] rounded-md mt-2" />
        </div>
        <div className="grid grid-cols-2 sm:flex sm:items-center gap-2 sm:gap-2.5 w-full sm:w-auto">
          <div className="h-9 w-full sm:w-32 bg-[#E5E5E5] dark:bg-[#262626] rounded-md" />
          <div className="h-9 w-full sm:w-32 bg-[#0A0A0A]/20 dark:bg-white/20 rounded-md" />
        </div>
      </div>
      ...
      <Card className="overflow-hidden !p-0 border border-[#E5E5E5] dark:border-[#262626] shadow-sm">
        ...
        <div className="p-4 sm:p-5 border-b border-[#E5E5E5] dark:border-[#262626] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2 overflow-x-auto">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-8 w-20 bg-[#E5E5E5] dark:bg-[#262626] rounded-md shrink-0" />
            ))}
          </div>
          <div className="flex items-center gap-2">
            <div className="h-8 w-full sm:w-48 bg-[#F0F0F0] dark:bg-[#1A1A1A] rounded-md" />
            <div className="h-8 w-28 bg-[#E5E5E5] dark:bg-[#262626] rounded-md" />
          </div>
        </div>
        ...
        <div className="divide-y divide-[#E5E5E5] dark:divide-[#262626]">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="px-5 py-4 flex items-center justify-between gap-4">
              ...
              <div className="h-4 w-24 bg-[#E5E5E5] dark:bg-[#262626] rounded hidden md:block" />
