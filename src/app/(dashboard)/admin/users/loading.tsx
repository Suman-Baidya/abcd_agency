          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="px-5 py-4 flex items-center justify-between gap-4">
              ...
              <div className="space-y-1.5 flex-1 min-w-0">
                <div className="h-4 w-44 bg-[#E5E5E5] dark:bg-[#262626] rounded" />
                <div className="h-3 w-32 bg-[#F0F0F0] dark:bg-[#1A1A1A] rounded" />
              </div>
              <div className="h-6 w-16 bg-[#E5E5E5] dark:bg-[#262626] rounded-md hidden sm:block" />
              <div className="h-4 w-28 bg-[#F0F0F0] dark:bg-[#1A1A1A] rounded hidden md:block" />
              <div className="h-7 w-20 bg-[#F0F0F0] dark:bg-[#1A1A1A] rounded" />
            </div>
          ))}
        </div>
      </Card>
